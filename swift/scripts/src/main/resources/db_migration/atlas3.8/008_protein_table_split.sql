...
(
  ...
  KEY protein_entry_ibfk_1 (protein_accnum_id),
  KEY protein_entry_ibfk_2 (protein_sequence_id),
  KEY protein_entry_ibfk_3 (protein_description_id),
  KEY protein_entry_ibfk_4 (curation_id),
