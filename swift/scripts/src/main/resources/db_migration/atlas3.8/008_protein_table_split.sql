...
(
  ...
  KEY protein_entry_idx_1 (protein_accnum_id),
  KEY protein_entry_idx_2 (protein_sequence_id),
  KEY protein_entry_idx_3 (protein_description_id),
  KEY protein_entry_idx_4 (curation_id),
