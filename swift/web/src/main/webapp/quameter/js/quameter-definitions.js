...
var metrics = [
        ...
        { code: "is_2", label: "IS-2", name: "Precursor", good: "range", simple: 1, range: [0,850], link: 'help/precursor_mz.html', desc: "Median precursor of identified peptide ions" },
        ...
        { code: "ms1_2a", label: "MS1-2A", name: "MS1 S/N", good: "high", simple: 1, range: [0,null], link: 'help/ms1_signal_to_noise.html', desc: "Ratio of maximum to median signal in MS1 spectra" },
        ...
        { code: "ms1_2b", label: "MS1-2B", name: "MS1 TIC", good: "high", simple: 1, link: 'help/ms1_ion_inject_time.html', desc: "Median MS1 Total Ion Current" },
        { code: "ms1_5a", label: "MS1-5A", name: "AMU Error Median", good: "high", simple: 0, desc: "Median difference between the theoretical precursor m/z and the measured precursor m/z value as reported in the scan header" },
        { code: "ms1_5b", label: "MS1-5B", name: "AMU Error Mean", good: "high", simple: 0, desc: "Mean absolute difference between the theoretical precursor m/z and the measured precursor m/z value as reported in the scan header" },
        { code: "ms1_5c", label: "MS1-5C", name: "PPM Error", good: "high", simple: 1, desc: "Median precursor mass error in PPM" },
        { code: "ms1_5d", label: "MS1-5D", name: "PPM Error Range", good: "high", simple: 0, desc: "Interquartile range for mass error in PPM" },
        { code: "ms2_1", label: "MS2-1", name: "MS2 Injection", good: "low", simple: 0, desc: "Median injection time for MS2 spectra" },
        { code: "ms2_2", label: "MS2-2", name: "MS2 S/N", good: "high", simple: 1, range: [0,null], desc: "Ratio of maximum to median signal in MS2 spectra" },
        { code: "ms2_3", label: "MS2-3", name: "MS2 Peaks#", good: "range", simple: 1, range: [0,null], desc: "Median number of MS2 peaks" },
        ...
        { code: "p_1", label: "P-1", name: "Search Score", good: "high", simple: 1, range: [0,null], desc: "Median peptide ID score" },
        { code: "p_2a", label: "P-2A", name: "MS2 Tryptic Spectra", good: "high", simple: 0, range: [0,null], desc: "Number of MS2 spectra identifying tryptic peptide ions" },
        { code: "p_2b", label: "P-2B", name: "MS2 Tryptic Ions", good: "high", simple: 0, range: [0,null], desc: "Number of tryptic peptide ions identified" },
        { code: "p_2c", label: "P-2C", name: "Distinct Peptides", good: "high", simple: 0, range: [0,null], desc: "Number of distinct identified tryptic peptide sequences, ignoring modifications and charge state" },
