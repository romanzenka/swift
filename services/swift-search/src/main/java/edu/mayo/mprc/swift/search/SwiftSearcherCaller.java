...
public final class SwiftSearcherCaller {
	...
	/**
	 * Just like {@link #startSearch} but blocks for up to {@link #SEARCH_TIMEOUT} before it either throws
	...
	public SearchProgressListener startSearch(final int swiftSearchId, final String batchName, final boolean fromScratch, final int priority, final int previousSearchId) {
