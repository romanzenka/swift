...
public final class MsmsEvalCache extends WorkCache<MSMSEvalWorkPacket> {
	...
	public static final class Ui implements ServiceUiFactory {
		...
		public void createUI(final DaemonConfig daemon, final ResourceConfig resource, final UiBuilder builder) {
			builder.property(CacheConfig.CACHE_FOLDER, "msmsEval cache folder", "When an input file gets evaluated by msmsEval, the result is stored in this folder. Subsequent attempts to evaluate same file will use the cached results."
