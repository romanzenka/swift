...
public final class QuameterUi implements Dao, UiConfigurationProvider, Lifecycle {
	...
	public static final List<QuameterMetric> METRICS = Lists.newArrayList(
			...
			QuameterMetric.builder("ms1_2b", "MS1-2B", "MS1 TIC", HIGH, true, "Median MS1 Total Ion Current").setLink("help/metrics/ms1_ion_inject_time.html").build(),
			...
			QuameterMetric.builder("ms2_2", "MS2-2", "MS2 S/N", HIGH, true, "Ratio of maximum to median signal in MS2 spectra").setLink("help/metrics/ms2_ion_inject_time.html").setRange(0.0, null).build(),
