 ...
 * The title is in format {@code TITLE=text text text... ([filename].[spectrum_from].[spectrum_to].[charge].dta)}
 * We use {@code spectrum_from} as our spectrum number. This should work for most of our .mgf files where
